...
#import "ORKFaceDetectionTool.h"

@interface ORKFaceDetectionTool ()

@property (atomic,assign) BOOL processingFaces;
@property (nonatomic,strong) CIDetector *faceDetector;
@property (nonatomic,readwrite,strong) NSArray *faces;

@end

@implementation ORKFaceDetectionTool

- (id)initWithVideoCamera:(GPUImageVideoCamera *)videoCamera
{
    self = [super init];
...
{
    if (!self.processingFaces && self.enabled)
    {
...
- (void)grepFacesForSampleBuffer:(CMSampleBufferRef)sampleBuffer
{
    ...
    {
        [self.delegate faceDetectionToolDidNotFindFaces:self];
    }
                 ...
                 andOrientation:(UIDeviceOrientation)curDeviceOrientation
{
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        for ( CIFaceFeature *faceFeature in featureArray) {
            ...
            if (self.enabled)
            {
                [self.delegate faceDetectionTool:self didProcessFace:faceFeature frame:faceRect];
            }
